...
<head>
	...
	<title>Log in - Product Catalog</title>
...
<body class="login-body">
	...
	<div class="login-wrap">
		<div class="login-card">
			<h1>Welcome back</h1>
			<p class="lead">Sign in to view the product catalog.</p>

			<?php if (!empty($denied)): ?>
				<div class="alert alert-error">Please log in to access that page.</div>
			<?php endif; ?>
			...
			<p class="foot-note">Don't have an account? <a href="<?= site_url('auth/register'); ?>">Register</a></p>
		</div>
	</div>
</body>
</html>